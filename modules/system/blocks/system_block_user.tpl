        ...
        <{else}>
            <a class="nav-link" href="<{xoAppUrl user.php}>" title="<{$block.lang_youraccount}>"><div class="sb-nav-link-icon"><i class="fa fa-user-circle"></i></div><{$block.lang_youraccount}></a> 
        <{/if}>
